...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb", "test/twitter/base_test.rb", "test/twitter/httpauth_test.rb", "test/twitter/oauth_test.rb", "test/twitter/request_test.rb", "test/twitter/search_test.rb", "test/twitter_test.rb", "examples/connect.rb", "examples/friendship_existance.rb", "examples/helpers/config_store.rb", "examples/httpauth.rb", "examples/ids.rb", "examples/search.rb", "examples/timeline.rb", "examples/unauthorized.rb", "examples/update.rb", "examples/user.rb"]
